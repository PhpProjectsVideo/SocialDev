 ...
 */
class UrlEntity extends \PhpProjects\SocialDev\Model\Url\UrlEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UrlEntity $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setUser(\PhpProjects\SocialDev\Model\User\UserEntity $user)
    {
